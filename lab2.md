---
layout: page
title: "Lab 2: Linux Shell"
permalink: /lab2.html
---

## Important Dates and Other Stuff

**Due** Friday, 02/26, midnight (11:59 pm).
...
In this project assignment, you will implement a *command line
interpreter (CLI)* or, as it is more commonly known, a *shell*. The
shell should operate in this basic way: when you type in a command
(in response to its prompt), the shell creates a child process that
executes the command you entered and then prompts for more user input
...
2. Commit all your changes by typing:
	...
	```bash
% git commit -am 'the final awesome solution of proj1: [Your Name] and [Your GMU ID]'
	```
...
The project assignment borrows a considerable amount of content from
